...
╔══════════════════════════════════════════════════════════╗
║ 阶段二：执行 (Execution)                                 ║
║ ├─→ 环境检测 (adb/frida/手机/模拟器/云手机/apktool/java)  ║
...
**核心特点：**
- **闭环迭代**：四阶段持续循环，自主纠错、逐步逼近目标
- **类人决策**：模拟人类逆向思维——先分析、再行动、后验证、最后改进
...
| 文档 | 内容 |
|------|------|
| `references/ai-agent-loop.md` | **AI Agent四阶段循环工作流（思考→执行→检查→修正）** |
...
*APK Crack Engine Pro v5.0 - AI Agent循环版 | 自主思考-执行-检查-修正*
